...
// Add the remaining 10 templates to complete the 20
export const additionalTemplates: ShaderTemplate[] = [
    // 11. Geometric Tunnel
    {
        name: "Tunnel",
...
// Additional templates to complete 20 total
additionalTemplates: ShaderTemplate[] = [
    // 14. Hexagon Grid
    {
        name: "Hexagons",
...
// Combine all templates (20 total)
export const allTemplates = [...shaderTemplates, ...additionalTemplates];

// Export the main array for use in the application
export { shaderTemplates };

// For backward compatibility, update the main export
